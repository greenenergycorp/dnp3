...
#define MACRO_RADIX_CASE(group, var) case(RADIX(group, var)): return Group##group##Var##var::Inst();
#define MACRO_GROUP_CASE(group) case(group): return Group##group##Var0::Inst();
