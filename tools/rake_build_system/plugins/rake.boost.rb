...
BOOST_THREAD_NAME = "boost_thread"
...
BOOST_LIB_NAMES = [BOOST_SYSTEM_NAME, BOOST_THREAD_NAME, BOOST_DATE_TIME_NAME, BOOST_PROGRAM_OPTIONS_NAME, BOOST_UNIT_TEST_NAME]
